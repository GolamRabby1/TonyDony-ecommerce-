...
export default function AboutPage() {
  // ✅ FIX: Removed unused hoveredCard state
  ...
  // ✅ FIX: Removed unused 'id' parameter and setHoveredCard call
  ...
  return (
    <div className="min-h-screen pt-16 pb-20 relative overflow-hidden">
      ...
      {/* ✅ FIX: Updated Tailwind canonical classes w-[600px] -> w-150, h-[600px] -> h-150 */}
      <div className="absolute top-40 left-0 w-150 h-150 bg-neon-blue/5 rounded-full blur-3xl"></div>
      <div className="absolute bottom-0 right-0 w-150 h-150 bg-emerald-green/5 rounded-full blur-3xl"></div>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          >
            {headingWords.map((word, i) => (
              <motion.span
                key={i}
                className={`text-6xl md:text-9xl font-display font-bold ${i === 1 ? 'text-transparent bg-clip-text bg-liner-to-r from-neon-blue to-emerald-green' : 'text-white'}`}
      ...
      {/* 🚀 MOVING BANNER 🚀 */}
      {/* ✅ FIX: Updated Tailwind canonical class bg-gradient-to-r -> bg-linear-to-r */}
      <section className="relative z-10 py-6 bg-linear-to-r from-neon-blue via-emerald-green to-accent-red overflow-hidden mb-20">
        <motion.div 
      ...
      <section className="px-4 md:px-8 max-w-7xl mx-auto mb-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.div 
            ...
            // ✅ FIX: Removed extra arguments in onMouseLeave
      ...
      <section className="px-4 md:px-8 max-w-4xl mx-auto mb-20">
        ...
        <div className="relative border-l-2 border-white/10 pl-8 ml-4 space-y-12">
          {timeline.map((item, i) => (
            ...
            >
              {/* Timeline Dot */}
              {/* ✅ FIX: Updated Tailwind canonical class -left-[calc(2rem+5px)] -> -left-9.25 */}
              <div className="absolute -left-9.25 top-0 w-3 h-3 rounded-full bg-emerald-green shadow-lg shadow-emerald-green/50"></div>
